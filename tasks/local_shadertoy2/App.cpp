  ...
  , useVsync{true}
{
  ...
  graphicsSampler = etna::Sampler(etna::Sampler::CreateInfo{.name = "graphicsSampler"});
  ...
  if (nextSwapchainImage)
  {
    ...
    ETNA_CHECK_VK_RESULT(currentCmdBuf.begin(vk::CommandBufferBeginInfo{}));
    {
      ...
      auto computeSet = etna::create_descriptor_set(
        ...
        currentCmdBuf,
        {etna::Binding{0, bufImage.genBinding(computeSampler.get(), vk::ImageLayout::eGeneral)}});
